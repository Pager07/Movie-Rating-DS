...
//    Update Methods
    // TODO: 24/02/2019 add/remove movie
    private static String[] processUpdate(Scanner scanner){
        System.out.println("What operation would you like to perform: [addMovie, addReview, removeMovie]");
        String response = scanner.nextLine().toLowerCase();
...
//    Movie Will Be Sent as: movieName, year, Genres
    private static String[] addMovie(Scanner scanner) {
        ...
        System.out.println("What is the Movie's Name: [Sabrina, Toy Story]");
        ...
        while(addingGenres) {
            ...
            if (scanner.next().toLowerCase().matches("no")) addingGenres = false;
        }
